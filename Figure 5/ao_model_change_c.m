% Adder per origin model is simulated for a population of cells. When a
...
function [times, cd_pop, td_pop, lb_pop, ld_pop, li_pop, li_t_pop, rate_pop] = ao_model_change_c(num_in, iter_num)
iter_num
...
dcd= num(num_in, 18); % change C-period by this many minutes after ch_cd

%-----Noise parameters
cvl=num(num_in,3)*num(num_in,2);  % standard deviation in growth rate
